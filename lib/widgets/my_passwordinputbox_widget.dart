...
class MyPasswordInputBoxWidget extends StatelessWidget {
  const MyPasswordInputBoxWidget({
    super.key,
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
            ...
            suffixIcon: Icon(Icons.remove_red_eye_rounded,color: CustomColors.primaryColor,)
        ),
      ),
    );
  }
